 ...
 * usarPortal: renderiza el panel via createPortal a body para escapar de
 * contenedores con overflow/backdrop-filter (p. ej. creacion-rapida).
 */
...
export function SelectorFrecuenciaPill({frecuencia, onChange, deshabilitado = false, usarPortal = false}: SelectorFrecuenciaPillProps): JSX.Element {
