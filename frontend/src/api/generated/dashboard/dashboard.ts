...
/**
 * @summary Lee el agregado propio del dashboard sin ejecutar sincronización ni escrituras bulk.
 */
...
export type getDashboardResponseError = (getDashboardResponse401 | getDashboardResponse500) & {
  headers: Headers;
};
...
export const getGetDashboardQueryOptions = <TData = Awaited<ReturnType<typeof getDashboard>>, TError = ErrorResponse>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getDashboard>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}
) => {
...
export type GetDashboardQueryError = ErrorResponse


export function useGetDashboard<TData = Awaited<ReturnType<typeof getDashboard>>, TError = ErrorResponse>(
