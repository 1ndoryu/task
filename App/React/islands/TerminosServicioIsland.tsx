        ...
        <div className="contenedorPaginaLegal">
            <div className="contenidoLegal">
                ...
                <section className="seccionLegal">
                    ...
                    <p>Al acceder y utilizar Task Nakomi ("el Servicio"), aceptas estar legalmente vinculado por estos Términos de Servicio ("Términos"). Si no estás de acuerdo con alguna parte de estos Términos, no debes utilizar el Servicio.</p>
                    <p>Nos reservamos el derecho de modificar estos Términos en cualquier momento. Los cambios entrarán en vigor inmediatamente después de su publicación. El uso continuado del Servicio después de la publicación de cambios constituye tu aceptación de los nuevos Términos.</p>
                </section>

                <section className="seccionLegal">
                    <h2>2. Descripción del Servicio</h2>
                    <p>Task Nakomi es una plataforma de productividad personal que permite a los usuarios:</p>
                    <ul>
                ...
                <section className="seccionLegal">
                    ...
                    <p>Soportamos autenticación mediante:</p>
                    <ul>
                        <li>
                            <strong>Google OAuth:</strong> Usando tu cuenta de Google existente
                        </li>
                        <li>
                            <strong>Email/Contraseña:</strong> Registro directo en la plataforma
                        </li>
                    </ul>

                    <h3>3.3 Seguridad</h3>
                    <p>Debes notificarnos inmediatamente sobre cualquier uso no autorizado de tu cuenta o cualquier otra violación de seguridad. No seremos responsables de pérdidas derivadas del uso no autorizado de tu cuenta.</p>
                </section>
                ...
                <section className="seccionLegal">
                    ...
                    <p>Eres el único responsable del contenido que creas, subes o compartes en el Servicio. Nos reservamos el derecho de eliminar contenido que viole estos Términos sin previo aviso.</p>
                </section>
                ...
                <section className="seccionLegal">
                    ...
                    <ul>
                        <li>
                            <strong>Plan Gratuito:</strong> Acceso básico con limitaciones funcionales
                        </li>
                        <li>
                            <strong>Plan Premium:</strong> Acceso completo mediante suscripción mensual/anual
                        </li>
                    </ul>

                    <h3>5.2 Procesamiento de Pagos</h3>
                    <p>
                        Los pagos se procesan a través de <strong>Stripe</strong>, un procesador de pagos certificado PCI-DSS. No almacenamos datos completos de tarjetas de crédito en nuestros servidores.
                    </p>
                    ...
                    <p>Nos reservamos el derecho de modificar los precios de las suscripciones con 30 días de aviso previo. Los cambios no afectarán tu ciclo de facturación actual.</p>
                </section>
                ...
                <section className="seccionLegal">
                    ...
                    <p>Todo el contenido del Servicio, incluyendo diseño, código, gráficos, logos y texto, es propiedad exclusiva de Task Nakomi o sus licenciantes y está protegido por leyes de propiedad intelectual.</p>

                    <h3>6.2 Derechos de tu Contenido</h3>
                    <p>Tú conservas todos los derechos sobre el contenido que creas en el Servicio. Al usar el Servicio, nos otorgas una licencia limitada, no exclusiva, transferible y sublicenciable para:</p>
                    <ul>
                    ...
                    <p>Esta licencia termina cuando eliminas tu contenido o tu cuenta, excepto para copias de backup que se eliminarán según nuestra política de retención.</p>
                </section>
                ...
                <section className="seccionLegal">
                    ...
                    <p>Puedes eliminar tu cuenta en cualquier momento desde la configuración de perfil. Todos tus datos serán programados para eliminación permanente después de 30 días.</p>

                    <h3>8.2 Terminación por Nosotros</h3>
                    <p>Nos reservamos el derecho de suspender o eliminar cuentas que:</p>
                    <ul>
                ...
                <section className="seccionLegal">
                    ...
                    <ul>
                        <li>El Servicio se proporciona "TAL CUAL" y "SEGÚN DISPONIBILIDAD" sin garantías de ningún tipo, expresas o implícitas</li>
                        <li>No garantizamos que el Servicio sea ininterrumpido, seguro o libre de errores</li>
                        <li>No somos responsables de daños directos, indirectos, incidentales, consecuentes o punitivos derivados del uso o imposibilidad de usar el Servicio</li>
                        <li>Nuestra responsabilidad total no excederá la cantidad pagada por ti en los últimos 12 meses o 100 EUR, lo que sea mayor</li>
                    </ul>
                </section>

                <section className="seccionLegal">
                    <h2>10. Indemnización</h2>
                    <p>Aceptas indemnizar, defender y eximir de responsabilidad a Task Nakomi, sus directores, empleados y afiliados de cualquier reclamación, pérdida, daño, responsabilidad y gasto (incluyendo honorarios legales razonables) derivados de:</p>
                    <ul>
                ...
                <section className="seccionLegal">
                    ...
                    <p>Estos Términos se regirán e interpretarán de acuerdo con las leyes de [especificar país/región], sin dar efecto a ninguna disposición sobre conflicto de leyes.</p>
                    <p>Cualquier disputa relacionada con estos Términos se resolverá en los tribunales competentes de [especificar jurisdicción].</p>
                </section>
                ...
                <section className="seccionLegal">
                    ...
                    <p>Estos Términos, junto con la Política de Privacidad, constituyen el acuerdo completo entre tú y Task Nakomi respecto al uso del Servicio.</p>

                    <h3>12.2 Renuncia</h3>
                    <p>La falta de ejercicio de cualquier derecho bajo estos Términos no constituye una renuncia a ese derecho.</p>
                    ...
                    <p>No puedes transferir o asignar tus derechos bajo estos Términos sin nuestro consentimiento previo por escrito. Nosotros podemos asignar estos Términos sin restricciones.</p>
                </section>
                ...
                <section className="seccionLegal">
                    ...
                    <ul className="listaContacto">
                        <li>
                            <strong>Email:</strong> legal@nakomi.studio
                        </li>
                        <li>
                ...
                <div className="notaFinal">
                    <p>
                        <strong>Nota:</strong> Al continuar usando Task Nakomi, confirmas que has leído, entendido y aceptado estos Términos de Servicio en su totalidad.
                    </p>
                </div>
            </div>
        </div>
