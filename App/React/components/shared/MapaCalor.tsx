 ...
 */
export function MapaCalor({datos, periodo = 'auto', fechaInicio, fechaFin, titulo, onClickDia, mostrarLeyenda: _mostrarLeyenda = true, tamanoCelda = 'normal', compacto = false, id = 'mapaCalor'}: MapaCalorProps): JSX.Element {
