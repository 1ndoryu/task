/*
 * useSelectorFrecuenciaPill
 * Lógica extraída de SelectorFrecuenciaPill para cumplir SRP
 * Gestiona panel expandible de selección de frecuencia para hábitos
 */
...
interface UseSelectorFrecuenciaPillParams {
...
export function useSelectorFrecuenciaPill({frecuencia, onChange, deshabilitado}: UseSelectorFrecuenciaPillParams): UseSelectorFrecuenciaPillReturn {
