...
- **Plugin EXP / gamificación (26-08-2026)**: panel fijo superior con barra de vida + EXP/nivel (una columna, siempre visible), activable/desactivable en configuraciones. Dificultad automática por IA (solo con plugin activo) guardada en el payload; EXP = dificultad × importancia al completar; vida empieza en 100 y baja por incumplimientos de hábitos (derivado del historial real, hecho durable). Plan: `Agente/planes/plan-plugin-exp-2026-08-26.md`.
